...
function NavLeftSide() {
  ...
  const [showNewDropDown, setShowDropDown] = useState(false);
  ...
  return (
    <div className="px-4 py-4 bg-mainBg text-mainFont ">
      <div
        className="flex w-fit  items-center gap-4 rounded-xl shadow-custom-light cursor-pointer hover:bg-[#E9EEF6] transition-all duration-300 bg-white px-4 py-2 text-3xl"
        onClick={toggleDropDown}
      >
        <span>+</span>
        <span className="text-lg">New</span>
      </div>
      <NewDropDown showNewDropDown={showNewDropDown} />
      ...
      <button className="mt-3 text-[#2757D0] hover:bg-slate-200 text-sm rounded-3xl border-[1.5px] py-2 px-4 ml-2 font-medium border-neutral-500 transition-all duration-300">
        Get more storage
      </button>
    </div>
  );
